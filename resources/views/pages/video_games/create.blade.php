...
@section('content')
    ...
    <div class="form-container" style="margin-top: 5rem">
        ...
        <form method="POST" action="{{ route('video_games.store') }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="box_art" name="box_art" required>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="checkbox-group">
                    ...
                    <input type="checkbox" id="nintendo_switch" name="platforms[]" value="nintendo_switch"
                           class="form-check-input">
                    <label for="nintendo_switch" class="checkbox-label">Nintendo Switch</label>
                    <input type="checkbox" id="playstation_5" name="platforms[]" value="playstation_5"
                           class="form-check-input">
                    <label for="playstation_5" class="checkbox-label">PlayStation 5</label>
                    <input type="checkbox" id="xbox_series" name="platforms[]" value="xbox_series"
                           class="form-check-input">
            ...
            <div class="form-group " >
                ...
                <div class="checkbox-group "  >
                    ...
                    <input type="checkbox" id="plataformas" name="genres[]" value="Plataformas"
                           class="form-check-input">
                    ...
                    <input type="checkbox" id="novela_visual" name="genres[]" value="Novela Visual"
                           class="form-check-input">
                    ...
                    <input type="checkbox" id="metroidvania" name="genres[]" value="Metroidvania"
                           class="form-check-input">
                    ...
                    <input type="checkbox" id="mundoabierto" name="genres[]" value="Mundoabierto"
                           class="form-check-input">
